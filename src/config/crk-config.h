/* src/config/crk-config.h.  Generated from crk-config.h.in by configure.  */
/* src/config/crk-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "cricket-coin.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cricket Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cricket Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "crk"
