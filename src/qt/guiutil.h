...
/** Utility functions used by the Cricket Qt UI.
 */
namespace GUIUtil
{
...
// Render Cricket addresses in monospace font
...
// Parse "crk:" URI into recipient object, return true on successful parsing
