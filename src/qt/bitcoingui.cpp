                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cricket Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cricket address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and crk: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cricket Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cricket Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cricket"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cricket addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cricket addresses"));
    ...
    openAction->setStatusTip(tr("Open a Cricket: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cricket Core help message to get a list with possible Cricket command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cricket Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cricket network", "", count));
}
...
{
    QString strTitle = tr("Cricket Core"); // default title
