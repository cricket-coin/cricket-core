...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Cricket server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cricket features */
        {"crk", "masternode", &masternode, true, true, false},
        {"crk", "listmasternodes", &listmasternodes, true, true, false},
        {"crk", "getmasternodecount", &getmasternodecount, true, true, false},
        {"crk", "masternodeconnect", &masternodeconnect, true, true, false},
        {"crk", "masternodecurrent", &masternodecurrent, true, true, false},
        {"crk", "masternodedebug", &masternodedebug, true, true, false},
        {"crk", "startmasternode", &startmasternode, true, true, false},
        {"crk", "createmasternodekey", &createmasternodekey, true, true, false},
        {"crk", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"crk", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"crk", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"crk", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"crk", "getmasternodescores", &getmasternodescores, true, true, false},
        {"crk", "mnbudget", &mnbudget, true, true, false},
        {"crk", "preparebudget", &preparebudget, true, true, false},
        {"crk", "submitbudget", &submitbudget, true, true, false},
        {"crk", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"crk", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"crk", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"crk", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"crk", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"crk", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"crk", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"crk", "checkbudgets", &checkbudgets, true, true, false},
        {"crk", "mnsync", &mnsync, true, true, false},
        {"crk", "spork", &spork, true, true, false},
        {"crk", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"crk", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use crkd, or the -server option to crk-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> crk-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:42461/\n";
}
