...
RESOURCES += src/qt/crk.qrc src/qt/crk_locale.qrc

TRANSLATIONS += src/qt/locale/crk_bg.ts \
                src/qt/locale/crk_de.ts \
                src/qt/locale/crk_en.ts \
                src/qt/locale/crk_es.ts \
                src/qt/locale/crk_fi.ts \
                src/qt/locale/crk_fr.ts \
                src/qt/locale/crk_it.ts \
                src/qt/locale/crk_ja.ts \
                src/qt/locale/crk_pl.ts \
                src/qt/locale/crk_pt.ts \
                src/qt/locale/crk_ru.ts \
                src/qt/locale/crk_sk.ts \
                src/qt/locale/crk_sv.ts \
                src/qt/locale/crk_vi.ts \
                src/qt/locale/crk_zh_CN.ts \
                src/qt/locale/crk_zh_TW.ts
