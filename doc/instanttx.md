...
This mechanism has been integrated into Bitcore-Node-Cricket which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Cricket-Project/insight-api-crk#web-socket-api](https://github.com/Cricket-Project/insight-api-crk#web-socket-api) 
* API: [https://github.com/Cricket-Project/insight-api-crk#instantsend-transactions](https://github.com/Cricket-Project/insight-api-crk#instantsend-transactions) 
...
By default, the Cricket Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Cricket Core daemon:
