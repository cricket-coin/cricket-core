...
In order to support loading of multiple wallets in crk-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is crk.cpp.
...
Changes to crk.cpp
----------------------
crk.cpp is the entry point into crk-qt, and as such, will require some minor modifications to provide hooks for
