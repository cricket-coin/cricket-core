Contributing to Cricket Core
============================

The Cricket Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cricket Core project, and is not to be
confused with overall Cricket Network Protocol consensus changes.

Whether a pull request is merged into Cricket Core rests with the project merge
...
Patches that change Cricket consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cricket consensus, it must have been
...
The project leader is the release manager for each Cricket Core release.
